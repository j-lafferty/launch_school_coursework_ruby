...
def verify_password(password) # password needs to be passed here
  puts '** Login **'
  print 'Password: '
  input = gets.chomp
...
if !password
  password = set_password # password needs to be assigned here
end

verify_password(password) # password needs to be passed here
